...
            // Mesh + Collider 用同一組幾何
            UpdateSweepMeshAndCollider(t);
...
    // ---------- Mesh + PolygonCollider 用同一組幾何 ----------
    private void UpdateSweepMeshAndCollider(float t)
    {
        if (sweepMesh == null || sweepCollider == null) return;
